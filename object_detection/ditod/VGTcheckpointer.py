...
class MyDetectionCheckpointer(DetectionCheckpointer):
    def _load_model(self, checkpoint: Any) -> _IncompatibleKeys:
        ...
        """
        DiT_checkpoint_state_dict = torch.load("/content/drive/MyDrive/github/vision-grid-transformer/VGT/dit-base-224-p16-500k-62d53a.pth", map_location=torch.device("cpu"))["model"]
